...
import ProductVariantsManager from "../components/ecommerce/products/ProductVariantsManager";
import BulkProductEditor from "../components/ecommerce/products/BulkProductEditor";
import ProductReviewsManager from "../components/ecommerce/products/ProductReviewsManager";
import InventoryAlertsManager from "../components/ecommerce/products/InventoryAlertsManager";
    ...
    <div className="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden hover:border-gray-600 transition-all">
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex flex-col gap-2 pt-2">
          ...
          <div className="flex gap-2">
            <ProductVariantsManager product={product} onUpdate={onRefresh} />
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex gap-2 flex-wrap justify-end">
        <InventoryAlertsManager products={products} onRefresh={fetchData} />
        <BulkProductEditor products={products} onComplete={fetchData} />
      </div>
