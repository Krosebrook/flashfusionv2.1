...
const plans = {
  Free: {
    ...
    price: 0,
    credits: "1,000",
    features: ["Basic feature access", "Community support"],
  },
  Creator: {
    name: "Creator",
    price: 29,
    credits: "50,000",
    features: ["All features", "Priority support", "Higher usage limits"],
  },
  Pro: {
    name: "Pro",
    price: 99,
...
const PricingCard = ({ plan, currentPlan, onSelectPlan }) => (
  <div
    className={`p-6 rounded-lg border ${currentPlan === plan.name ? "border-blue-500 bg-gray-800" : "border-gray-700 bg-gray-800/50"}`}
  >
...
export default function BillingPage() {
  ...
  const handleSelectPlan = async (planName) => {
    try {
      ...
      alert(
        "Plan updated! Note: This is a demo and not connected to a real payment gateway."
      );
