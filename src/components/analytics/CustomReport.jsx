    ...
    <div className="space-y-6">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              {metrics.map((metric) => (
                <div key={metric.id} className="flex items-center gap-3 p-3 bg-gray-900 rounded-lg">
                  <Checkbox
      ...
      <Card className="bg-gray-800 border-gray-700 p-6">
        ...
        <div className="bg-gray-900 p-4 rounded-lg text-sm font-mono text-gray-300">
          <p>Report Type: <span className="text-green-400">{reportType}</span></p>
          <p className="mt-2">Selected Metrics: <span className="text-blue-400">{selectedMetrics.length}</span></p>
          <p className="mt-2 text-gray-500">
            This report will include comprehensive analytics data for the selected metrics.
          </p>
        </div>
      </Card>
