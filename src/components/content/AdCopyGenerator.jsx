    ...
    <div className="space-y-4">
        ...
        <Card key={field} className="bg-gray-800 border-gray-700 p-4">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-gray-400">Headline {idx + 1}</h4>
      ...
      {['description1', 'description2'].map((field, idx) => (
        <Card key={field} className="bg-gray-800 border-gray-700 p-4">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-gray-400">Description {idx + 1}</h4>
              <Badge variant="outline" className="text-xs">
                {generatedAd[field].length}/{adPlatforms.google.specs[field]}
              </Badge>
            </div>
  ...
  const renderFacebookAd = () => (
    <div className="space-y-4">
      <Card className="bg-gray-800 border-gray-700 p-4">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            ...
            <Badge variant="outline" className="text-xs">
              {generatedAd.headline.length}/{adPlatforms.facebook.specs.headline}
            </Badge>
          </div>
          <Button
            size="sm"
      ...
      <Card className="bg-gray-800 border-gray-700 p-4">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            <h4 className="text-sm font-semibold text-gray-400">Primary Text</h4>
            <Badge variant="outline" className="text-xs">
              {generatedAd.primaryText.length}/{adPlatforms.facebook.specs.primaryText}
            </Badge>
          </div>
          <Button
            size="sm"
      ...
      <Card className="bg-gray-800 border-gray-700 p-4">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            ...
            <Badge variant="outline" className="text-xs">
              {generatedAd.description.length}/{adPlatforms.facebook.specs.description}
            </Badge>
          </div>
          <Button
            size="sm"
  ...
  return (
    <div className="space-y-6">
      <Card className="bg-gray-800 border-gray-700 p-6">
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium mb-2">Ad Platform</label>
