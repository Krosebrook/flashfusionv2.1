...
import { Sparkles, Download, Loader2, Check, Zap } from "lucide-react";
...
const brandStyles = [
  ...
  },
  {
    ...
    colors: ["#1A1A2E", "#C5A572", "#FFFFFF"],
    mood: "Sophisticated, premium, timeless",
  },
  {
    id: "natural",
    name: "Natural & Organic",
    colors: ["#2D5016", "#B4C7A8", "#F4E4C1"],
    mood: "Earthy, sustainable, authentic",
  },
  {
    id: "playful",
    name: "Playful & Creative",
    colors: ["#FF6F91", "#FFC75F", "#845EC2"],
    mood: "Fun, youthful, imaginative",
  },
];
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (user.credits_remaining < 200) {
        alert(
          "Insufficient credits. You need at least 200 credits to generate a brand kit."
        );
        setIsGenerating(false);
        return;
      }

      const selectedStyle = brandStyles.find(
        (s) => s.id === formData.brandStyle
      );
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData({ ...formData, brandStyle: value })
                }
              >
            ...
            <Button
              ...
              disabled={
                isGenerating || !formData.businessName || !formData.industry
              }
              ...
              <TabsContent value="colors" className="space-y-6 mt-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
                  {generatedKit.color_details?.map((color, index) => (
                    <div
                      key={index}
                      className="space-y-2 bg-gray-900 p-3 rounded-lg border border-gray-700"
                    >
                      <div
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-gray-900 p-6 rounded-lg border border-gray-700">
                    ...
                    <p
                      ...
                      style={{ fontFamily: generatedKit.fonts?.heading }}
                    >
                  ...
                  <div className="bg-gray-900 p-6 rounded-lg border border-gray-700">
                    ...
                    <p
                      ...
                      style={{ fontFamily: generatedKit.fonts?.body }}
                    >
