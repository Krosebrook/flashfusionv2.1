    ...
    try {
      ...
      if (response.success) {
        ...
        const updatedProduct = {
          ...product,
          platforms: [
            ...new Set([...(product.platforms || []), ...selectedPlatforms]),
          ],
          platform_ids: {
                ...
                {isPublished && product.platform_ids?.[platform.id] && (
                  <Button
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      window.open(
                        `https://${platform.id.toLowerCase()}.com/product/${product.platform_ids[platform.id]}`,
                        "_blank"
                      );
                    }}
                  >
        ...
        >
          {isPublishing ? (
            <>
              ...
              Publishing to {selectedPlatforms.length} Channel
      ...
      {product.platforms?.length > 0 && !publishResults && (
        <Card className="bg-gray-800 border-gray-700 p-4">
          <div className="flex items-center justify-between">
            <p className="text-sm text-gray-400">
              This product is currently published on {product.platforms.length}{" "}
              channel{product.platforms.length !== 1 ? "s" : ""}
            </p>
